...
Usage:
  python backend/train_jepa.py --data_dir ./my_dataset --epochs 10 --batch_size 16
"""
...
def train_jepa(data_dir="./dataset", epochs=5, batch_size=8, lr=1e-4, save_path="backend/jepa_weights.pth"):
